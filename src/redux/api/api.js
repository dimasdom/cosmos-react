...
export const getSearchResultsPicturesAPI = async (search,page)=>{
    return axios.get(`https://images-api.nasa.gov/search?q=${search}&page=${page}&media_type=image`).then(response=>{return response.data})
}